...
public class EjercicioArrays {
    ...
    public static void main(String[] args) {
        ...
        //Encuentra la nota mínima y máxima junto con su índice
        clase1.EncontrarMinMax();

        // Muestra la información general
        clase1.MostrarInfo();

        //Calcula y muestra la estadística de notas
        clase1.calcularEstadistica();

        //Determina aprobados y suspensos
        clase1.AprobadosSuspensos();

        //Muestra resumen de aprobados y suspensos
